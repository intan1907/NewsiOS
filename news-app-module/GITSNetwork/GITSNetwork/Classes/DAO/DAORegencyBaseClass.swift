...
public final class DAORegencyBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var code: Int?
  public var data: DAORegencyData?
  ...
  public required init(json: JSON) {
    ...
    data = DAORegencyData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? DAORegencyData
